...
const mockItemDescriptions: Record<number, string> = {
  200: '网络梗图同款粽子造型，非官方周边，适合考研宿舍桌面摆放。',
  201: '宿舍抽象饮料组合展示数据，非品牌官方联名，三件内容以图片为准。',
  202: '按网络梗图命名的冰红茶商品，非本人代言或官方联名，仅供校园玩梗展示。',
  203: '奶龙奶蛙抽象门贴一对，适合贴在宿舍门内侧。',
  204: '鸡你太美动作梗立牌，非官方周边，适合放在篮球架或书桌旁。',
  205: '按键后循环播放哈基米片段的整活小音箱，熄灯后请谨慎使用。',
  206: '粉色小熊表情包造型抱枕，非官方联名，已清洗。',
  207: '经典退退退表情包门贴，考试周和答辩周均可使用。',
  208: '乌萨奇发疯表情桌面摆件，适合放在论文和作业旁边。',
  209: '派大星经典发问梗鼠标垫，适合在小组作业中持续灵魂拷问。',
  210: '大学生期末精神状态立牌，适合图书馆占座提醒。',
  211: '会发出短促曼波音效的小猫钥匙扣，公共区域请谨慎按键。',
  212: '香蕉猫外壳充电宝，容量标称 5000mAh，续航建议当面测试。',
  213: '悲伤蛙图案抱枕，适合期末周趴桌使用。',
  214: '吉吉国王红温形态摆件，适合在代码报错时放在显示器旁。',
  215: '无语菩萨梗图护身符，适合答辩、汇报和小组作业现场。',
