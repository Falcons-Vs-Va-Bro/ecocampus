...
- 数据库约束与锁策略：[`docs/database-constraints-and-locking.md`](docs/database-constraints-and-locking.md)
...
默认配置使用 H2 内存数据库，表结构和种子数据由 Flyway migration 初始化，便于在未安装 MySQL/Redis 时启动骨架服务。
