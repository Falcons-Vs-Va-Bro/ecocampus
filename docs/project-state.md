...
- Sites + Mac mini 部署：`docs/deployment-sites-macmini.md`
...
- `frontend/sites/` 提供现有 React SPA 的 OpenAI Sites 部署适配层，保留 React Router 多路由并生成 Worker 兼容产物；生产构建使用 `ecocampus-api.teamdsb.online` 真实 API。
